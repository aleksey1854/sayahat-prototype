    ...
    <section className="section section--tight" id="how-to-get" style={{ background: "var(--surface-2)" }}>
      <div className="wrap">
        <div className="section-head">
          {/* Подзаголовка нет намеренно: мысль про одно здание с автовокзалом
              уже стоит подписью под адресом в панели и в строке «Покупки
              и поездки — в одном месте» под кнопками. Третий повтор подряд
              читается как вода. */}
